 ...
 public function register_hook_callbacks() {
    ...
    function admin_init() {
     ...
     foreach ( $this->settings_sections as $section => $sec ) {
      ...
      if ( !is_null( $sec['submenu'] ) && isset( $sec['submenu'] ) ) {
       foreach ( $sec['submenu'] as $subsec ) {
        add_settings_section( $subsec, $subsec, $callback, $subsec );
       }
      }

      add_settings_section( $sec['id'], $sec['title'], $callback, $sec['id'] );
     }
  ...
  foreach ( $this->settings_sections as $section ) {
   foreach ($section['submenu'] as $submenu) {
    ...
    <?php foreach ( $this->settings_sections as $tab ): ?>
       <li class="dpr-be-group-menu-li dpr-be-group-menu-parent-li <?php echo !is_null( $tab['submenu'] ) ? 'has-sub' : ''; ?>">

                    <a href="#<?php echo $tab['id']; ?>" id="<?php echo $tab['id']; ?>" class="dpr-be-group-tab-link-a">
                     <?php if ( !is_null( $tab['submenu'] ) ) : ?>
     ...
     ?>
        ...
        <div class="dpr-be-main">
            <div id="dpr-be-infobar">
                ...
                <a href="" id="" class="dpr-btn">Reset Section</a><a href="" id="" class="dpr-btn">Reset All</a>
            </div>
            <div class="dpr-be-notification"></div>

            <?php foreach ( $this->settings_sections as $form ) : ?>
             
             <div class="dpr-be-content">
    ...
    function script() {
     ...
     <script>
      jQuery(document).ready(function($) {
                ...
                // show active tab
                $('.dpr-be-content').hide();
                $('.dpr-be-content').first().show();
                $('.dpr-be-group-menu-parent-li').first().addClass('active');
                // var getlocalvar =  JSON.parse( localStorage.getItem('dpactivetab') );
                // if ( typeof getlocalvar == 'undefined' && getlocalvar == null ) {
                // } else {

                //  $( getlocalvar ).parent().css( 'display', 'none' );
                //  $( getlocalvar ).show();
                //  $( getlocalvar ).addClass('active');
                // console.log( JSON.parse(localStorage.getItem('dpactivetab') ) );
                // }

                // Switches option sections
                $('.dpr-be-group-menu-parent-li a,.dpr-be-group-menu-child-li a').click(function(e) {
					...
					$('.dpr-be-content').fadeOut('fast');
					$('.dpr-be-group-menu-parent-li , .dpr-be-group-menu-child-li').removeClass('active');

					// show and fade in 
					$('.dpr-be-content #' + $thisid ).parent().parent().fadeIn('fast');
...
//s
				...
				// save ajaxi
				$('.dpr-save-btn').click(function(e) {
					e.preventDefault();
					$('.depc_save_ajax').trigger('submit');
				});
				$('.depc_save_ajax').submit( function (e) {

					e.preventDefault();

					var form =  $(this).serialize();

					$.post( 'options.php', form ).error( 
						function() {

							$('.dpr-be-notification').addClass('notice-yellow');
							$('.dpr-be-notification').fadeIn('slow');
							$('.dpr-be-notification').text('<?php _e( 'Changes Not Saved.', 'depc' ) ?> ');

						}).success( function() {

							$('.dpr-be-notification').addClass('notice-green');
							$('.dpr-be-notification').fadeIn('slow');
							$('.dpr-be-notification').text('<?php _e( 'All Settings Succsesfully Saved.', 'depc' ) ?> ');

							setTimeout(function() {

								$('.dpr-be-notification').fadeOut('slow');
